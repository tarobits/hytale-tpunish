...
public class EditPresetsGui extends InteractiveCustomUIPage<GuiUtil.ListPunishmentsData> {
    ...
    @Override
    public void handleDataEvent(@NonNullDecl Ref<EntityStore> ref, @NonNullDecl Store<EntityStore> store, @NonNullDecl GuiUtil.ListPunishmentsData data) {
        ...
        switch (data.action) {
            ...
            case "TypeDropdown":
                ...
                GuiUtil.buildPunishmentHeader(uiCommandBuilder, uiEventBuilder, "#Header", null, this.typesSelected, false);
                break;
            case "TabButton":
    ...
    public void build(@NonNullDecl Ref<EntityStore> ref, @NonNullDecl UICommandBuilder uiCommandBuilder, @NonNullDecl UIEventBuilder uiEventBuilder, @NonNullDecl Store<EntityStore> store) {
        ...
        GuiUtil.buildTabs(GuiUtil.ListTypes.EDIT, this.tabButtonMap, this.selectedTab, this.presetConfigs, ref, uiCommandBuilder, uiEventBuilder, store, null);
    }
}
