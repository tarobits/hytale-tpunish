...
public class PunishCommand extends CommandBase {
    ...
    public PunishCommand() {
        super("punish", "tarobits.punishments.command.punish");

        this.playerArg = this.withRequiredArg(
                "tarobits.punishments.command.punish.args.player.display",
                "tarobits.punishments.command.punish.args.player.desc", ArgTypes.GAME_PROFILE_LOOKUP
        );
